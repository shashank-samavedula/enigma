...
#title
Label(window, text="Enigma Encryption System", font=("comic sans ms", 25), background='white').pack(padx=10, pady=10, side=TOP)
...
#rotor labels
rotor1lab = Label(frame1, text='Rotor I(Slow)', padx=10, pady=5, borderwidth=0, background='white')
rotor1lab.grid(row=0, column=0)
rotor2lab = Label(frame1, text='Rotor II(Medium)', padx=10, pady=5, borderwidth=0, background='white')
rotor2lab.grid(row=0, column=1)
rotor3lab = Label(frame1, text='Rotor III(Fast)', padx=10, pady=5, borderwidth=0, background='white')
...
def _help():
    ...
    label = Label(frameHelpText, text=helpText, background = 'white', anchor='s') #font=("comic sans ms"), background='white')
